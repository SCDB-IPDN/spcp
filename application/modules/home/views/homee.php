...
<html lang="en-US" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <div class="main">
      <section class="module bg-white" id="alt-features">
          <div class="container">
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="alt-features-item">
                  ...
                  <h3 class="alt-features-title font-alt">Dasar Seleksi</h3>Berdasarkan Surat Menteri Pendayagunaan Aparatur Negara dan Reformasi Birokrasi Nomor B/435/M.SM.01.00/2020 tanggal 6 Mei 2020 Hal Rencana Pembukaan Pendaftaran dan Seleksi Sekolah Kedinasan Tahun 2020, Kementerian Dalam Negeri Republik Indonesia memberikan kesempatan bagi Putra/Putri Warga Negara Republik Indonesia untuk mengikuti Seleksi Penerimaan Calon Praja (SPCP) Institut Pemerintahan Dalam Negeri (IPDN) Tahun <?php echo date('Y'); ?>.
                </div>
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-mobile"></span></div>
                  <h3 class="alt-features-title font-alt">Maksud dan Tujuan</h3>Maksud dan tujuan pelaksanaan seleksi penerimaan calon Praja IPDN adalah untuk menjaring calon Praja IPDN yang berkualitas dalam hal memiliki dasar pengetahuan dan keterampilan yang memadai, kesehatan diri yang prima, kemampuan psikologis diri yang mampu berkembang secara potensial, integritas dan kejujuran diri yang terpercaya, kemampuan berkomunikasi yang efektif, dan kesiapan untuk bekerja di seluruh wilayah Negara Kesatuan Republik Indonesia.
                </div>
              </div>
              ...
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-mobile"></span></div>
                  <h3 class="alt-features-title font-alt">Prinsip Pelaksanaan</h3>Untuk menjaring Calon Praja IPDN yang berkualitas, sistem seleksi penerimaan Calon Praja IPDN dilakukan secara jujur dalam keseluruhan tahapan seleksi, transparan terkait keseluruhan tahap dan informasi hasil tes kepada seluruh peserta tes dan masyarakat melalui media online, adil tanpa membedakan agama dan asal usul, akuntabel dalam arti keseluruhan hasil tes dapat dipertanggungjawabkan. 
                </div>
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-mobile"></span></div>
                  <h3 class="alt-features-title font-alt">Mekanisme Seleksi</h3>Maksud dan tujuan pelaksanaan seleksi penerimaan calon Praja IPDN adalah untuk menjaring calon Praja IPDN yang berkualitas dalam hal memiliki dasar pengetahuan dan keterampilan yang memadai, kesehatan diri yang prima, kemampuan psikologis diri yang mampu berkembang secara potensial, integritas dan kejujuran diri yang terpercaya, kemampuan berkomunikasi yang efektif, dan kesiapan untuk bekerja di seluruh wilayah Negara Kesatuan Republik Indonesia..
                </div>
              </div>
            </div>
          </div>
