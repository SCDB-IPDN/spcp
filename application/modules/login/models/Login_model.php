    ...
    function login_user($spcp, $password)
    {
        ...
        if ($query->num_rows() > 0) {
            ...
            if (!empty($result)) {
                ...
                $this->session->set_userdata('tgl_lahir_ayah', $data_user->tgl_lahir_ayah);
                ...
                $this->session->set_userdata('tgl_lahir_ibu', $data_user->tgl_lahir_ibu);
                ...
                $this->session->set_userdata('tgl_lahir_wali', $data_user->tgl_lahir_wali);
