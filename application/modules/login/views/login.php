...
<body class="login-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            ...
            <div class="navbar-translate">
                <a class="navbar-brand" href="#" rel="tooltip" title="Designed by TIM IT IPDN" data-placement="bottom"
                    target="_blank">
                    Menu
                </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation"
                data-nav-image="<?php echo base_url('assets/login/img/blurred-image-1.jpg'); ?>">
                <ul class="navbar-nav">
                    <li class="nav-item">
    ...
    <div class="page-header clear-filter" filter-color="orange">
        <div class="page-header-image"
            style="background-image:url(https://mmc.tirto.id/image/2019/03/13/gedung-ipdn_ratio-16x9.jpg)"></div>
        <div class="content">
            <div class="container">
                    ...
                    <div class="card card-login card-plain">
                        <form class="form" method="POST" action="login/proses">
                            <div class="card-header text-center">
                                ...
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Lambang_IPDN.png/781px-Lambang_IPDN.png"
                                    width="50%" alt="">
                                <!-- </div> -->
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-footer text-center">
                                    <button type="submit"
                                        class="btn btn-primary btn-round btn-lg btn-block">Login</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script src="<?php echo base_url('assets/login/js/plugins/bootstrap-datepicker.js'); ?>" type="text/javascript">
    </script>
    <!--  Google Maps Plugin    -->
